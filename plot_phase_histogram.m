...
% *************************************************************************
%
% PLOT_PHASE_HISTOGRAM plots the histogram of phase differences derived 
...
function plot_phase_histogram(lat_map,n_grid_1d)
    ...
    % Plot a histogram of the phase differences
    figure
    histogram(phase_diffs,12,'FaceColor', [0.3 0.3 0.3], 'EdgeColor', 'k')
    title('Histogram of Phase Differences','FontSize',16)
    set(gcf,'color','w')
    xlabel(sprintf('Phase (ms)\nIndex = %.3f', si))
    ylabel('N')
